...
Revision ID: 1fcf089b56a3
Revises: 728ea8ef4dd8
Create Date: 2020-10-20 19:16:45.543581
...
revision = '1fcf089b56a3'
down_revision = '728ea8ef4dd8'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('venue_id', sa.INTEGER(), server_default=sa.text("nextval('venues_venue_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.PrimaryKeyConstraint('venue_id', name='venues_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('artists',
    sa.Column('artist_id', sa.INTEGER(), server_default=sa.text("nextval('artists_artist_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('city', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
    sa.Column('state', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
    sa.Column('phone', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['artist_id'], ['artists.artist_id'], name='shows_artist_id_fkey'),
    sa.ForeignKeyConstraint(['venue_id'], ['venues.venue_id'], name='shows_venue_id_fkey'),
